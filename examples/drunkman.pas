...
uses
  Crt, StringUtils, SySutils, Graph, Joystick;
...
var
  ...
  M3R : byte;
  PGMMEM : word;
  PCOLR : array[0..3] of byte absolute $2C0;  // PCOLR_byte_array
  HPOSP : array[0..3] of byte absolute $D000;  // HPOSP_byte_array
  HPOSM : array[0..3] of byte absolute $D004;  // HPOSM_byte_array
  SIZEP : array[0..3] of byte absolute $D008;  // SIZEP_byte_array
  P0_DATA : array[0..7] of byte = (56, 68, 124, 124, 124, 124, 124, 56);  // P0_DATA_byte_array
...
var
  P1_DATA : array[0..10] of byte = (28, 34, 62, 62, 28, 8, 8, 8, 8, 28, 62);  // P1_DATA_byte_array
  P2_DATA : array[0..14] of byte = (24, 24, 24, 60, 126, 126, 126, 126, 66, 90, 66, 126, 66, 126, 126);  // P2_DATA_byte_array
  P3_DATA : array[0..14] of byte = (36, 149, 85, 62, 66, 129, 129, 165, 129, 153, 129, 165, 153, 66, 60);  // P3_DATA_byte_array
  M3_DATA : array[0..10] of byte = (128, 128, 255, 64, 64, 255, 128, 128, 255, 64, 64);  // M3_DATA_byte_array
...
// PUT SOME TEXT ON SCREEN
  ...
  Write('Hik! Shoot glasses by pressing Hik!');
  Writeln;
